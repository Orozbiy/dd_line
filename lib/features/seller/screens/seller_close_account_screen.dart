...
/// Сатуучу дүкөндөн баш тартканда көрсөтүлүүчү экран.
/// Товарларды checkbox менен тандап, бир нечесин же баарын
/// бирдей өчүрүүгө мүмкүндүк берет, андан соң аккаунттан чыгарат.
class SellerCloseAccountScreen extends StatefulWidget {
  ...
  @override
  State<SellerCloseAccountScreen> createState() =>
      _SellerCloseAccountScreenState();
}
...
class _SellerCloseAccountScreenState extends State<SellerCloseAccountScreen> {
  ...
  void _toggleSelectAll() {
    setState(() {
      if (_selectedIds.length == _products.length) {
        ...
        _selectedIds
          ..clear()
          ..addAll(_products.map((p) => p['id'] as String));
      }
    });
  }

  // ── Тандалган товарларды өчүрүү ──
  Future<void> _deleteSelected() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          '${_selectedIds.length} товар толугу менен өчүрүлөт. Бул кайтарылгыс. Улантасызбы?',
  ...
  // ── Бардык товарларды өчүрүп, аккаунттан чыгуу ──
  Future<void> _closeAccount() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Бардык товарларыңыз толугу менен өчүрүлөт жана аккаунттан чыгасыз. Бул кайтарылгыс. Улантасызбы?',
          style: AppTextStyles.bodyMedium,
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () => Navigator.pop(context, true),
            child: const Text('Ооба, баш тартам',
                style: TextStyle(color: AppColors.error)),
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Дүкөндөн баш тартуу',
                      ...
                      ? Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('Товар жок', style: AppTextStyles.headingSmall),
                            ],
                          ),
                        )
                      : ListView.builder(
                    ...
                    children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: _isDeleting
                                ...
                                : Text(
                                    '🗑️ Тандалган товарларды өчүрүү (${_selectedIds.length})',
                                    style: AppTextStyles.labelLarge
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          ...
                          child: Text(
                            '🚪 Дүкөндөн баш тартуу (баарын өчүрүү)',
                            style: AppTextStyles.labelLarge
