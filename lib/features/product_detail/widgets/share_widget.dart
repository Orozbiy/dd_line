...
Widget get _smsSvg => const Icon(Icons.sms_rounded,
    color: Color(0xFF34C759), size: 26);

Widget get _moreSvg => const Icon(Icons.more_horiz_rounded,
...
class _WhatsAppPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final wp = Paint()..color = Colors.white..style = PaintingStyle.stroke
...
class _InstagramPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(innerRect, Radius.circular(size.width * 0.15)),
      wp,
    );
    canvas.drawCircle(Offset(size.width / 2, size.height / 2),
        size.width * 0.2, wp);
    final dot = Paint()..color = Colors.white..style = PaintingStyle.fill;
    canvas.drawCircle(Offset(size.width * 0.72, size.height * 0.28),
        size.width * 0.07, dot);
  }
  @override
  bool shouldRepaint(_) => false;
