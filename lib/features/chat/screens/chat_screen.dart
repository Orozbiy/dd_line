  ...
  Future<void> _deleteSelected() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('${_selectedIds.length} билдирүү өчүрүлөт. Улантасызбы?'),
        actions: [
          TextButton(
                ...
                children: [
                  CircleAvatar(
                    ...
                    child: widget.otherAvatarUrl.isEmpty
                        ? const Icon(Icons.person, size: 18, color: AppColors.grey400)
                        : null,
                  ),
